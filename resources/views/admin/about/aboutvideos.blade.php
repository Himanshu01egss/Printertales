      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-12">
               ...
               <div class="card">
                  <form action="{{url('admin/about/videoadded  ')}}" method="post"  enctype="multipart/form-data">
                     @csrf
                     <div class="card-body">
                        <div class="row">
                           <div class="col-md-12">
                                 ...
                                 <div class="form-group">
                                    <label for="image">Image (image size should be 577x716px)</label>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="btn btn-group">
                                    <a href="{{url('admin/about/videodelete/'.$item->id)}}" onclick="confirm('Are You Want To Delete This Serivce?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                 </div>
                              </td>
                           </tr>
                           @endforeach
