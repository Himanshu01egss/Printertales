      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-md-12">
               ...
               <div class="card">
                  <form action="{{url('admin/home/save_features')}}" method="post"  enctype="multipart/form-data">
                     @csrf
                     <div class="card-body">
                        <div class="row">
                           <div class="col-md-12">
                           ...
                           <tr>
                              ...
                              <td>
                              	<div class="btn btn-group">
                                    <a href="{{url('admin/home/featuresedit/'.$item->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                                 </div>
                                 <div class="btn btn-group">
                                    <a href="{{url('admin/home/featuresdelete/'.$item->id)}}" onclick="confirm('Are You Want To Delete This Serivce?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                 </div>
                              </td>
                           </tr>
                           @endforeach
